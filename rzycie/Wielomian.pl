...
%Rozpoznanie wielomianow jednej zmienej o wspolczynnikach liczbowych 

/*
1) x jest wielomianem zmiennej x c - liczba jest wielomianem dowolnej zmiennej
2) Jezeli W, W1, W2 sa wielomianami zm. x, ti -W, W1+W2, W1-W2, W1*W2, W^N (N liczba naturalna)
